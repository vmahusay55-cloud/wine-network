...
export function IconCard({
  ...
  return (
    <article className="motion-card w-full border-l-2 border-white/12 bg-[#201F1F] px-6 py-6 text-left lg:min-h-[260px] lg:w-[440px] lg:px-6 lg:py-6">
      <Image
        src={iconSrc}
        alt=""
        width={iconWidth}
      ...
      <p className="mt-3 text-[15px] font-light leading-[22px] text-white/55">
